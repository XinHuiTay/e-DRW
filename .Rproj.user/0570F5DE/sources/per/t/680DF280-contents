...
evaluateExprLR <- function(expr_training, expr_test, train_Control)
{
  ...
  rfFit <- train(class ~ ., data=expr_training, method="glm", family="binomial", trControl=train_Control)
...
evaluateGreedyLR <- function(expr_training, expr_test, expr_crosstest, train_Control)
{
  ...
  eTestSet <- evaluateExprLR(expr_training[, c(names(expr_training),"class")], expr_test[, c(names(expr_test),"class")], train_Control)
  ...
  {
    eTestSetTmp <- evaluateExprLR(expr_training[, c(names(expr_training)[c(flag, i)],"class")], expr_test[, c(names(expr_test)[c(flag, i)],"class")], train_Control)
